...
def main():
    ...
    if not zip_bytes:
        ...
        print(f"[INFO] Summary: timestamp={current_time.isoformat()}, fetched=0, processed=0, skipped=0, fetch_seconds={fetch_seconds:.2f}, total_seconds={time.perf_counter() - started_at:.2f}")
        return
